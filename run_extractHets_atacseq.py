...
# python3 /hpc/group/allenlab/scarlett/script/BEASTIE/run_extractHets_atacseq.py /hpc/group/allenlab/scarlett/ATACseq/HG00096.no_chr.content.SNPs.hets.filtered.vcf.gz /hpc/group/allenlab/scarlett/ATACseq/peak_annotation.gz /hpc/group/allenlab/scarlett/ATACseq/hetSNP.tsv --chr_start 1 --chr_end 1
#=========================================================================
# parameter arguments
...
#
print("derp")
count_all_het_sites_forpeaks(vcfFilename,outputFilename,chr_start,chr_end,annotation_file)
