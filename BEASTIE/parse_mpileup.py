...
def Parse_mpileup_allChr(prefix,vcfgz_dir,pileup_dir,min_cov,out,DEBUG=False):
    inputPileup = None
    inputGZ = None
    inputGZ=vcfgz_dir
    ...
    if DEBUG is True:
        print("DEBUG USE - finish loading pileup file: %s"%(pileup_dir))
    ...
    stream_in = open(pileup_dir, "r")
    with open(pileup_dir, "r") as stream_in:
