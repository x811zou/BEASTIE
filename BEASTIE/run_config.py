...
if not os.path.isfile(meta_file):
    print(f"Oops! meta data file ({meta_file}) not found. Please try again ...")
    exit(1)
###############################################
# BEASTIE
###############################################
try:
    cmd = f"python stan_wrapper.py {local_dir} {vcfgz_file} {pileup_file} {meta_file} {min_total_cov} {min_single_cov} {prefix} {out} {modelName} {STAN} {alpha} {sigma} {cutoff}"
