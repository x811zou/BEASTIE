...
def parse_stan_output(models,input_file,tmp_output_file,stan_output_file,init_file,sigma,lambdas_file,out_path,outfix,alphas,alpha_list,predicted_lambda_modeldata=False,default_lambda=False,selfdefined_lambda=False):
    ############################################################################################
    ##### 1. default
    ...
    if str(default_lambda) == "True":
        ...
        if str(predicted_lambda_modeldata) == "True":
            ...
            prob_tail_lambda = []
            prob_sum_lambda = []
            lambdas=pd.read_csv(lambdas_file, delimiter='\t', names = ['gene_ID', 'median', 'prob', 'prob_log2', 'total_reads', 'num_hets','predicted_lambda'])
        model_theta = []       # 150
        model_theta_med = []   # 150
        model_med_prob = []    # 150
...
def main():
    ...
    models = "/data/allenlab/scarlett/software/cmdstan/examples/"+str(model)+"/"+str(model)
    ...
    parse_stan_output(models,input_file,tmp_output_file,stan_output_file,init_file,sigma,lambdas_file,out_path,outfix,alphas,selfdefined_alpha,predicted_lambda_modeldata=predicted_lambda_modeldata,default_lambda=default_lambda,selfdefined_lambda=selfdefined_lambda)
