...
def _build(args):
    specification="s"+str(args.sigma)+"_a"+str(args.alpha)+"_sinCov"+str(args.min_single_cov)+"_totCov"+str(args.min_total_cov)+"_W"+str(args.WARMUP)+"K"+str(args.KEEPER)
    logname = os.path.join(args.in_path, args.out, specification, "log", f"{args.prefix}-{today.strftime('%b-%d-%Y')}.log")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ath,args.out,"/",specification,"/log/",f"{args.prefix}-{today.strftime('%b-%d-%Y')}.log")
